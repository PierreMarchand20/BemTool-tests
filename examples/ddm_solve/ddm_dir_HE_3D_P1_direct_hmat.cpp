...
int main(int argc, char *argv[]) {
    ...
    opt.parse(argc, argv, rank == 0,{
        ...
        std::forward_as_tuple("save=(0|1)", "integer", HPDDM::Option::Arg::argument),
        ...
        std::forward_as_tuple("frequency=<1>", "frequency.", HPDDM::Option::Arg::numeric),
    ...
    BIO_Generator<HE_DL_3D_P1xP1,P1_2D> generator_K(dof,kappa);
